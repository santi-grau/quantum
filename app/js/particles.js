...
var Particles = function( parent, settings ){
	...
	this.settings.pointSize = this.settings.pointSize || new THREE.Vector4( 0, 0.6, 1, 15 ); // min size, max size, min range, max range
	this.settings.oscillation = this.settings.oscillation || new THREE.Vector4( 0, 1, 0, 100 ); // oscillation distance

	this.settings.dispersion = this.settings.dispersion || new THREE.Vector4( 0, 1, 0, 100 ); // dispersion distance
	
	this.settings.color = this.settings.color || new THREE.Vector3( 0, 1, 1 ); // color of particles
